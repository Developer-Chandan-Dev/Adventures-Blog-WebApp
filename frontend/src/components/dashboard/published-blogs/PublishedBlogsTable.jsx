...
const PublishedBlogsTable = ({
  ...
  return (
    <div className="w-full relative h-auto ">
      <div className="pb-2 mt-5 bg-[#ffffff94] rounded overflow-auto">
        <div className="flex items-center justify-between gap-x-3 py-3 mr-3">
...
export default PublishedBlogsTable;
